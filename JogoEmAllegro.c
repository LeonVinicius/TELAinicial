...
int main() {
    ...
    ALLEGRO_BITMAP* next = al_load_bitmap("C:/Users/Leon/source/repos/JogoEmAllegro/JogoEmAllegro/NEXT.png");
    ALLEGRO_BITMAP* gameover = al_load_bitmap("C:/Users/Leon/source/repos/JogoEmAllegro/JogoEmAllegro/creditosFINAIS.png");


    ALLEGRO_BITMAP* transicao1 = al_load_bitmap("C:\\Users\\Leon\\source\\repos\\JogoEmAllegro\\JogoEmAllegro\\introFASE1.png");
    ALLEGRO_BITMAP* transicao2= al_load_bitmap("C:\\Users\\Leon\\source\\repos\\JogoEmAllegro\\JogoEmAllegro\\introFASE2.png");
    ALLEGRO_BITMAP* transicao3 = al_load_bitmap("C:\\Users\\Leon\\source\\repos\\JogoEmAllegro\\JogoEmAllegro\\introFASE3.png");
    ALLEGRO_FONT* font = al_load_ttf_font("C:/Users/Leon/Downloads/fonte pixel art/Minecraft.ttf", 17, 0);
        ...
        if (evento.type == ALLEGRO_EVENT_MOUSE_BUTTON_DOWN && evento.mouse.button == 1) {
            ...
            if (evento.mouse.x >= mouselocal_x && evento.mouse.x <= mouselocal_x + mouselocal_largura &&
                ...
                if (transicao_fases == 3) {
                    ...
                    creditos++;
                   // jogo_ativo = true;
                    system("C:/Users/Leon/source/repos/CompitandoOsCodigos/x64/Debug/CompitandoOsCodigos.exe");
                   // jogo_ativo = false;
                    transicao = false;
                    //historia = true;
                //   fase_atual = casa;
